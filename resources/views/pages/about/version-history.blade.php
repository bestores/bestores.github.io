...
@section('content')
  <div class="version-history">
    ...
    <h3>{{ env('APP_NAME') }} 1.0.2 <small>Release Date: 10/23/18</small></h3>
    ...
    <h3>{{ env('APP_NAME') }} 1.0.0 <small>Release Date: 10/04/17</small></h3>
    ...
    <h3>{{ env('APP_NAME') }} Beta <small>Release Date: 06/12/17</small></h3>
